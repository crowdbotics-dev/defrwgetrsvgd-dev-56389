"""
Django settings for defrwgetrsvgd_dev_56389 project.
...
ROOT_URLCONF = 'defrwgetrsvgd_dev_56389.urls'
...
WSGI_APPLICATION = 'defrwgetrsvgd_dev_56389.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "defrwgetrsvgd_dev_56389 API",
    "DESCRIPTION": "API documentation for defrwgetrsvgd_dev_56389 App",
    "VERSION": "v1",
}
